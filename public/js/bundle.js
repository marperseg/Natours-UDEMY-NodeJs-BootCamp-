      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Logged in Successfylly!');
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:8468/api/v1/users/updateMyPassword' : 'http://localhost:8468/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfylly!"));
            window.setTimeout(function () {
              location.assign('/');
            }, 1200);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return (0, _axios.default)("http://localhost:8468/api/v1/bookings/checkout-session/".concat(tourId));
        case 4:
          session = _context.sent;
          // TEMP SOLUTION
          console.log('SESSION.....', session.data, session.data.tour._id, session.data.user._id, session.data.tour.price);
          (0, _alerts.showAlert)('error', 'Feature not implemented yet, redirecting...');
          window.setTimeout(function () {
            location.assign("http://localhost:8468/?tour=".concat(session.data.tour._id, "&user=").concat(session.data.user._id, "&price=").concat(session.data.tour.price));
          }, 1200);
        ...
        case 10:
          ...
          (0, _alerts.showAlert)('error', 'Feature not implemented...');
        case 14:
        case "end":
          return _context.stop();
      }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11848" + '/');
